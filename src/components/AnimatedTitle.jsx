...
class AnimatedTitle extends Component {
  componentDidMount() {
    ...
    const LetterLines = mojs.stagger(mojs.Html);

    const sLetter = new LetterLines({
      ...letterLine,
      quantifier: 4,
      el: ['#S-line1', '#S-line2', '#S-line3', '#S-line4'],
      stroke: [colors.yellow, colors.blue, colors.red, colors.green],
      strokeDasharray: [
        79.4126205444336,
        80.08199310302734,
        80.21588134765625,
    ...
    const iLetter = new LetterLines({
      ...letterLine,
      quantifier: 4,
      el: ['#I-line1', '#I-line2', '#I-line3', '#I-line4'],
      stroke: [colors.green, colors.red, colors.yellow, colors.blue],
      strokeDasharray: 33.606529235839844,
      strokeDashoffset: { 33.606529235839844: 0 },
    });
    ...
    const mLetter = new LetterLines({
      ...nLines,
      quantifier: 8,
      delay: [0, 0, 0, 0, 280, 308.32, 337.68, 373.57],
      el: [
    ...
    const nLetter = new LetterLines({
      ...nLines,
      el: ['#N-line1', '#N-line2', '#N-line3', '#N-line4'],
      stroke: [colors.yellow, colors.green, colors.blue, colors.red],
    });

    const simonDiameter = document.querySelector('#simon').width.baseVal.value;

    const simon = new mojs.Html({
      angleZ: { 0: `360 * (100vw / ${3.1416 * simonDiameter})` },
      delay: 500,
      duration: 1000,
      el: '#simon',
      isShowStart: true,
    ...
    return (
      <div className="AnimatedTitle">
        ...
        <svg width="47.008" height="135.103" viewBox="0 0 12.437566 35.745961">
          <path d="M1.064 34.676L1.054 1.07" id="I-line1" />
          <path d="M4.494 1.07L4.504 34.676" id="I-line2" />
          <path d="M7.943 34.676L7.933 1.07" id="I-line3" />
          <path d="M11.405307 1.0694677L11.415 34.676" id="I-line4" />
        </svg>
        ...
        <svg id="simon" width="138.896" height="138.896" viewBox="0 0 36.749559 36.749559">
          <g transform="translate(-41.188 -54.013)">
            ...
            />
            <path
              d="M77.938 72.388a18.375 18.375 0 0 1-11.343 16.976A18.375 18.375 0 0 1 46.57 85.38a18.375 18.375 0 0 1-3.983-20.025 18.375 18.375 0 0 1 16.976-11.343v18.375z"
              fill={colors.green}
            />
            <path
              d="M77.938 72.388A18.375 18.375 0 0 1 68.75 88.3a18.375 18.375 0 0 1-18.375 0 18.375 18.375 0 0 1-9.188-15.913"
              fill={colors.blue}
            />
            <path
              d="M77.938 72.388a18.375 18.375 0 0 1-18.375 18.374V72.388z"
              fill={colors.yellow}
            />
          </g>
        </svg>
